defmodule Web.Color do
  ...
  def format(string) do
    ...
    |> String.replace("{brown}", "<span class='brown'>")
    |> String.replace("{dark-green}", "<span class='dark-green'>")
    |> String.replace("{grey}", "<span class='grey'>")
    |> String.replace("{light-grey}", "<span class='light-grey'>")
