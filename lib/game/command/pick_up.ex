defmodule Game.Command.PickUp do
  ...
  """
  @spec run(args :: [], command :: String.t, session :: Session.t, state :: map) :: :ok | {:update, map}
  def run([item_name], _command, _session, state = %{socket: socket, save: %{room_id: room_id}}) do
